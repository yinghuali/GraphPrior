...
path_x_np = '/Users/yinghua.li/Documents/Pycharm/GNNEST/data/citeseer/x_np.pkl'
path_edge_index = '/Users/yinghua.li/Documents/Pycharm/GNNEST/data/citeseer/edge_index_np.pkl'
path_y = '/Users/yinghua.li/Documents/Pycharm/GNNEST/data/citeseer/y_np.pkl'
epochs = 50
save_model_name = 'citeseer_graphsage.pt'
save_pre_name = 'pre_np_citeseer_graphsage.pkl'
...
def train(x, edge_index, y):
    ...
    model = GraphSAGE(num_node_features, 16, num_classes).to(device)
    x = x.to(device)
...
# train: 0.9961340206185567
# test: 0.7607607607607607