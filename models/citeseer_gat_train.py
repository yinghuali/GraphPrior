...
train_all_idx, test_idx, train_all_y, test_y = train_test_split(idx_np, y, test_size=0.3, random_state=17)

train_idx, candidate_idx, train_y, candidate_y = train_test_split(train_all_idx, train_all_y, test_size=0.5, random_state=17)
