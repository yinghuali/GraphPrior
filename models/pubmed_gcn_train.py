...
epochs = 50
save_model_name = 'pubmed_gcn.pt'
save_pre_name = 'pre_np_pubmed_gcn.pkl'
...
def train(x, edge_index, y):
    ...
    # model = GCN()
    # model.load_state_dict(torch.load('pubmed_gcn.pt'))
...
# train: 0.843199768132744
# test: 0.8453346855983773
