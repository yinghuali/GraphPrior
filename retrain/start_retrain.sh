...
python retraining.py --path_model_file '../mutation/all_mutation_models/repeat_1/cora_gcn' --model_name 'gcn' --target_model_path './target_models/cora_gcn.pt' --path_x_np '../mutation/data/cora/x_np.pkl' --path_edge_index '../mutation/data/cora/edge_index_np.pkl' --path_y '../mutation/data/cora/y_np.pkl' --save_name './res/cora_gcn.pkl'
python retraining.py --path_model_file '../mutation/all_mutation_models/repeat_1/cora_gat' --model_name 'gat' --target_model_path './target_models/cora_gat.pt' --path_x_np '../mutation/data/cora/x_np.pkl' --path_edge_index '../mutation/data/cora/edge_index_np.pkl' --path_y '../mutation/data/cora/y_np.pkl' --save_name './res/cora_gat.pkl'
python retraining.py --path_model_file '../mutation/all_mutation_models/repeat_1/cora_graphsage' --model_name 'graphsage' --target_model_path './target_models/cora_graphsage.pt' --path_x_np '../mutation/data/cora/x_np.pkl' --path_edge_index '../mutation/data/cora/edge_index_np.pkl' --path_y '../mutation/data/cora/y_np.pkl' --save_name './res/cora_graphsage.pkl'
