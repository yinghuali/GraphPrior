...
path_save_label_deepgini = 'deepgini_citeseer_tagcn_label.csv'
path_save_label_variance = 'variance_citeseer_tagcn_label.csv'
path_save_label_least = 'least_citeseer_tagcn_label.csv'
