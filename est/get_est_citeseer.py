...
path_save_label_margin = 'margin_citeseer_tagcn_label.csv'
path_save_label_deepgini = 'data_label/deepgini_citeseer_tagcn_label.csv'
path_save_label_variance = 'data_label/variance_citeseer_tagcn_label.csv'
path_save_label_least = 'data_label/least_citeseer_tagcn_label.csv'
path_model = '/Users/yinghua.li/Documents/Pycharm/GNNEST/models/citeseer_tagcn.pt'
epochs = 500
model_name = 'tagcn'
